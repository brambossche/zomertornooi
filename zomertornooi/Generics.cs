...
namespace ProgramDefinitions
{
    ...
    public class Databaseconfig
    {
       ...
       // Data Source = (LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Data\proj\zomertornooi\Databases\TestDB\UnitHibernateTest.mdf;Integrated Security = True; Connect Timeout = 30
        ...
        public static IPersistenceConfigurer DB_UnitHibernateTest = MsSqlConfiguration.MsSql2012.ConnectionString(@"Data Source=AMSBGNB366\SQLEXPRESS;Initial Catalog=ZomerTornooi2016;Integrated Security=True");
